...
Fixed values describing physical hardware. Not adjustable.
...
**Spark Configuration (spark-defaults.conf)** — Spark configuration parameters relevant to this cluster topology. Contains two categories:
...
- `spark.hadoop.fs.s3a.endpoint` → placeholder for Ceph RGW address (e.g., `https://<rgw-vip>:7480`)
