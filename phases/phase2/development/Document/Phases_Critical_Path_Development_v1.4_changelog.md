...
- `phases/phase1/development/deliverables/dev_cluster_phase1_model.html` — hardware-spec table, solver grid, worker spec rows, `RAM_NODE` constant, physical-RAM warning threshold, Revisions section
- `phases/phase2/development/deliverables/dev_cluster_phase1_model.html` — identical to phase1 (cp; diff confirmed)
...
- `phases/phase2/development/Document/CP_HIPAA_Compliance_v1.0.md` (4 v1.4 → v1.5)
- `phases/phase2/development/Document/CP_Okta_v1.1.md` (7 v1.4 → v1.5)
- `phases/phase2/development/Document/SOW_timeline_status.md` (v1.3 → v1.5)
- `phases/phase1/development/README.md` (v1.3 → v1.5)
- `phases/phase1/development/Notes/ksolves-april24-status-review.md` (v1.3 → v1.5)
- `phases/phase1/development/vendor_comms/phase1_vendor_questions.txt` (v1.3 → v1.5)
