...
**Raw output:** `phases/development/phase2/Incoming/proxmox_audit.md` (gitignored — contains auth keys)
...
For the actual key values: `phases/development/phase2/Incoming/proxmox_audit.md` (gitignored).
