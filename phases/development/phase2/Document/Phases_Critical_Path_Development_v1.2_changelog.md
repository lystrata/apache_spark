...
**Cross-references bumped to v1.3:** `TODO.md`, `CLAUDE.md`, `phases/development/phase1/README.md`, `phases/development/phase1/Notes/ksolves-april24-status-review.md`, `phases/development/phase1/vendor_comms/phase1_vendor_questions.txt`, `phases/development/phase2/Ready_For_Review/CP_Okta_v1.0.md`, `phases/development/phase2/Ready_For_Review/MSB-PMC01_airflow_host_briefing_v1.0.md`, `phases/development/phase2/Document/phases_critical_path_development_tracker_v1.3.html`, `phases/development/phase2/Document/SOW_timeline_status.md`.

**Not changed:**
- `phases/production/phase2/Ready_For_Review/Phases_Critical_Path_Production_v0.1.md` retains its `_Forked from Phases_Critical_Path_Development_v1.2.md_` reference (historical fork lineage; production scope to be revised separately when production work begins). Production-side BLOCKER.1 will be inherently satisfied by then since Ksolves' Windows host will already be in place from dev.
- `phases/development/phase2/Document/Phases_Critical_Path_Development_v1.2.md` (the now-promoted v1.2) is left as-is — it accurately represents the state at promotion.
- `phases/development/phase2/Document/Phases_Critical_Path_Development_v1.1_changelog.md` (the prior v1.0 → v1.1 changelog) remains as a separate historical record.
